package com.zyllion.sigma.product.web.rest;

import com.zyllion.sigma.product.domain.Product;
import com.zyllion.sigma.product.service.ProductService;
import com.zyllion.sigma.product.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.zyllion.sigma.product.domain.Product}.
 */
@RestController
@RequestMapping("/api")
